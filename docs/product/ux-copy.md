---
title: UX Copy (Interface Strings)
category: product
owner: product-designer
status: approved
related: [../content/editorial-style.md, ../shared/terminology.md]
...
- Post-activity prompt: "Nice sorting. Want to keep this progress? A free account saves your progress across devices."
- Post-pass prompt (primary): "Section complete! Create a free account to save your result and get notified when the next section opens."
- Migration toast: "Progress saved to your account." · Resume banner: "Continue where you left off: {step}"
- New device: "We couldn't find saved progress on this device. Guest progress stays on the device where you learned - an account keeps it everywhere."

## Assessment & feedback
- Intro expectations: "6–7 questions · Pass at 80% · Retake any time with different questions · If you don't pass, we'll show you exactly what to review"
- Practice label: "Knowledge check - practice, not graded"
- Prefixes: "Correct - here's why:" / "Not quite - here's the clue:" · Ambiguity: "Honestly, this one's debatable - here's what would settle it:"
- Pass: "Section complete - well done" · Fail: "Not this time - here's what to review" + "You were strong on {strong}. Focus on {weak} and retake when you're ready - the questions will be different."
